...
Route::prefix('/')->middleware([])->group(function () {
    ...
    Route::prefix('/shop')->group(function () {
        ...
        // Order By Wardrobe
        Route::get('/order-wardrobe', [HomeController::class, 'orderwardrobe'])->name('orderwardrobe');
        Route::get('/order-wardrobe/{style}', [HomeController::class, 'orderwardrobebyname'])->name('orderwardrobebyname');
        Route::get('/order-wardrobe/{style?}/{assembly?}/{colour?}', [HomeController::class, 'orderwardrobebycolour'])->name('orderwardrobebycolour');
        Route::get('/view-all-order-wardrobe/{style?}/{assembly?}/{colour?}', [HomeController::class, 'viewallorderwardrobebycolour'])->name('viewallorderwardrobebycolour');
    ...
    Route::prefix('/help-and-guides')->group(function () {
        ...
        Route::get('/wardrobe-terminologies', [HomeController::class, 'terminology'])->name('terminology');
        Route::get('/need-help-measuring', [HomeController::class, 'needhelp'])->name('needhelp');
        Route::get('/how-will-my-wardrobe-arrive', [HomeController::class, 'wardrobearrive'])->name('wardrobearrive');
