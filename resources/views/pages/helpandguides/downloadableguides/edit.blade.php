            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Downloadable Guide</h4>
            ...
            <div class="row gutters">
                <div class="col-12">
                    <div class="card p-lg-5 p-4">
                        <form action="{{ route('downloadableguides.update', $guide->id) }}" method="post"
                            class="auth-input" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6 form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title"
                                        value="{{ $guide->title }}" placeholder="Enter Guide Title" autofocus>
                                </div>
                                <div class="col-lg-6 form-group mb-2">
                                    ...
                                    <select name="file_type" id="file_type" class="form-control select2">
                                        ...
                                        <option value="guide" {{ $guide->type == 'guide' ? 'selected' : '' }}>Guide
                                        </option>
                                        <option value="resource" {{ $guide->type == 'resource' ? 'selected' : '' }}>
                                            Resource</option>
                                    </select>
                                </div>
                                <div class="col-lg-6 form-group mb-2">
