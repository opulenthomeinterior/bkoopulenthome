    ...
    <section class="container-fluid px-lg-5 px-md-3 px-3">
        <div class="row mx-auto">
            <div class="col-lg-9 col-md-10 col-sm-12 mx-auto p-0">
                ...
                <h4 class="text-dark pt-3">Planning a brand new wardrobe is an exciting project, but it can be a daunting
                    ...
                    components in the production and installation of a wardrobe. Let’s get started.</h4>
        ...
        <div class="row mx-auto">
            <div class="col-lg-9 col-md-10 col-sm-12 mx-auto p-0">
                ...
                <p>Known as the kick plate or kick board, this is used to bridge the gap between the floor and the
                    bottom of your wardrobe cabinets.<br>
                    The plinth is used to hide away cabinet legs and unsightly gaps giving the wardrobe a complete tidy
                    finish.</p>
            </div>
            <div class="col-lg-9 col-md-10 col-sm-12 mx-auto p-0">
            ...
            <div class="col-lg-9 col-md-10 col-sm-12 mx-auto p-0">
                ...
                <p>The cornice is the strip of decorative trim at the top of the wall cabinets. The cornice eliminates
                    the empty space at the top of the wall cabinets. Only available in our Shaker wardrobes.
                </p>
            </div>
            <div class="col-lg-9 col-md-10 col-sm-12 mx-auto p-0">
            ...
            <div class="col-lg-9 col-md-10 col-sm-12 mx-auto p-0">
                ...
                <p>The appliance door is used for disguising various cooking and cleaning appliances in your wardrobe
