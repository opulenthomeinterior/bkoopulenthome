    ...
    <section class="container-fluid px-lg-5 py-4 px-md-3 px-3">
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <h4 class="text-dark">
                    Having been making, packing and distributing wardrobes, we have developed trusted methods
    ...
    <section class="container-fluid px-lg-5 py-4 px-md-3 px-3" style="background-color: #f0f0f0;">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <p>
                    Flat-Packed wardrobes will be delivered to you by our courier DX.
                    <br><br>
                    ...
                    <br><br>
                    Rigid Wardrobes are delivered by TDL, the goods are packed onto a pallet(s) and wrapped in shrink
