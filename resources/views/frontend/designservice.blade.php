    ...
    <section class="container-fluid px-lg-5 py-4 px-md-3 px-3">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <h4>
                    At BW Online we want to make ordering a trade wardrobe as easy as possible. From offering a FREE
                    Virtual Design Wardrobe Service to providing 'How To' Videos we are constantly looking at ways to
                    support you.
                </h4>
        ...
        <div class="row">
            <form action="{{ route('submit.designservice') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row py-3">
                        <div class="col-12">
                            <label class="py-1">Please upload your wardrobe measurements and/or existing plans</label>
