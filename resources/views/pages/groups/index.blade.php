                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <a class="btn btn-primary btn-sm float-end" href="{{ route('group.create') }}">Add Group</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <div class="d-flex flex-row gap-2">
                                                    <a class="btn btn-soft-info btn-sm d-inline-block edit-button" href="{{ route('group.edit', $group->id) }}"
                                                        title="Edit group">
